  ...
  <div class="registerForm">
    ...
    <v-form ref="form" lazy-validation>
      ...
      <div class="text-errors">
        ...
        <p 
          v-if="(!$v.phone.numeric || !$v.phone.maxLength || !$v.phone.minLength) 
      ...
      <div class="text-errors">
        ...
        <p 
          v-if="(!$v.password.specialCharacters || !$v.password.minLength) 
                && $v.password.$dirty" class="text-danger"
        >
      ...
      <div>
        ...
        <p 
          class="text-errors" 
          v-if="!$v.dayOfBirth.required && $v.dayOfBirth.$dirty">
...
export default {
  ...
  methods: {
    ...
    // callApi: call('manager/xgetUsers'),
    async registerUser() {
      this.$v.$touch();
      this.isLoading = true
      ...
      this.$store.dispatch("manager/addUsers", infoUser)
      // call("manager/addUsers", infoUser) 
      users.push(infoUser)
